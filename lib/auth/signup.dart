...
class _SignupScreenState extends State<SignupScreen> {
  ...
  String? _validatePhone(String? value) {
    ...
    // Optional: Add more specific validation for your country
    // For Philippines format: +63XXXXXXXXX or 09XXXXXXXXX
    if (!RegExp(r'^(\+63|0)\d{10}$').hasMatch(cleanedPhone)) {
              ...
              TextFormField(
                ...
                onChanged: (value) {
                  ...
                  if (value.startsWith('09') && value.length == 11) {
                    ...
                    final formatted = '+63${value.substring(1)}';
